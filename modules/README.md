...
These materials expand the agenda into detailed subsection guides. Everything
is designed to run on one Mac using the open-source tools described in the
[prerequisites](../prerequisites/README.md).

Each guide contains exact commands, named fixture paths, expected evidence, a
...
Each module ends with an assessment artifact used by the next module.
